...
# ====== paths / constants ======
DEFAULT_QUEUE_PATH = "/media/sf_REC/posting/queue_yolo.jsonl"
...
GORO_BLOCK = (
    ...
    "最終工程にYOLOを追加して実験運用中なので、可愛い瞬間や違和感があればコメントで教えてもらえると助かります。"
)

HASHTAGS = "#まさお #うさぎ #rabbit #bunny #cuteanimals #shorts #AI切り抜き"
